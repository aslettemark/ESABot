...
public abstract class CommandExecutor {
     ...
     * 
     * @param channel
     *            The channel the command was executed in, if in pm channel = null
     * @param sender
     *            The nickname of the command executor
     * @param login
     *            The login of the command executor
     * @param hostname
     *            The hostname of the command executor
     * @param command
     *            The command with removed prefixes
     * @param pm
     *            Wether the command was called in a PM
     */
